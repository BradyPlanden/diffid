...
class Adam:
    ...
    def init(
        ...
        bounds: typing.Optional[
            typing.Sequence[tuple[builtins.float, builtins.float]]
        ] = None,
    ) -> AdamState:
        r"""
...
class AdamState:
    ...
    def best(
        self,
    ) -> typing.Optional[tuple[builtins.list[builtins.float], builtins.float]]:
        r"""
...
class Problem:
    ...
    def sample(
        self,
        initial: typing.Optional[typing.Sequence[builtins.float]] = None,
        sampler: typing.Optional[MetropolisHastings | DynamicNestedSampler] = None,
    ) -> typing.Any:
        r"""
        Sample from the problem starting from `initial` using the supplied sampler.
        """
    def get_config(self, _key: builtins.str) -> typing.Optional[builtins.float]:
        r"""
