...
1. **[Installation](installation.md)** - Platform-specific installation instructions and troubleshooting
2. **[5-Minute Quickstart](quickstart.md)** - Simple scalar optimisation with the Rosenbrock function
3. **[First ODE Fit](first-ode-fit.md)** - Fitting differential equations to data with DiffSL
4. **[Core Concepts](concepts.md)** - Understanding builders, problems, and the ask/tell pattern
